...
app.config['NAME'] = "CookieMonster Pt. 2"
app.config['FLAG'] = os.environ['PART_TWO_FLAG']
app.config['KEY'] = PBKDF2(os.environ['COOKIE_JAR_KEY'], bytes(os.environ['PART_TWO_FLAG'], 'ascii'), 16, count=1000000)
app.config['COOKIE_ID'] = 'SESSIONID2'

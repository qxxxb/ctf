...
app.config['NAME'] = "CookieMonster Pt. 1"
app.config['FLAG'] = os.environ['PART_ONE_FLAG']

# https://pycryptodome.readthedocs.io/en/latest/src/protocol/kdf.html
# PBKDF2(password, salt, dkLen, count)
app.config['KEY'] = PBKDF2(os.environ['COOKIE_JAR_KEY'], bytes(os.environ['PART_ONE_FLAG'], 'ascii'), 16, count=1000000)

app.config['COOKIE_ID'] = 'SESSIONID1'
